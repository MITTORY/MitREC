...
### Основной сценарий:
1. **Шаг:** Пользователь запускает Marvel Snap.
   - *Действие:* Запуск приложения Marvel Snap.
   
2. **Шаг:** Пользователь запускает программу MitREC для захвата экрана.
   - *Действие:* Запуск MitREC с выбором опции захвата экрана.
   
3. **Шаг:** Пользователь принимает участие в турнире, осуществляя игровые действия.
   - *Действие:* Активное участие в турнире Marvel Snap.
   
4. **Шаг:** MitREC записывает экран во время участия пользователя в турнире.
   - *Действие:* Автоматический захват экрана программой MitREC.
   
5. **Шаг:** По завершении турнира, пользователь останавливает запись в MitREC.
