...
namespace MitREC
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            //string savedToken = ConfigurationService.GetTokenFromConfiguration();

            //if (!string.IsNullOrEmpty(savedToken) && TokenService.ValidateToken(savedToken))
            //{
            //    // Токен действителен, пользователь автоматически авторизован
            //    // Вы можете выполнить дополнительные действия или просто отобразить главное окно
            //    ShowMainWindow();
            //}
            //else
            //{
            //    // Пользователь должен ввести учетные данные
            //    // Отобразите окно авторизации
            //    // ...
            //}
            ...
            // Создайте список для хранения информации о дисплеях
            List<DisplayInfo> displayInfoList = new List<DisplayInfo>();

            // Заполните список информацией о дисплеях
            ...
            // Установите источник данных для ComboBox
        ...
        private void MainWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                DisplayBox.SelectedIndex = 0; // Выбираем первый элемент (первый дисплей) по умолчанию
            }
        }
        ...
        private void RecButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (waveIn == null)
            {
                ...
                if (!string.IsNullOrEmpty(savePath))
                {
                    ...
                    // Определите экран для записи на основе выбранного имени
        ...
        {
            // Проверяем, что у нас есть путь к водяному знаку
            if (!string.IsNullOrEmpty(watermarkImagePath))
            {
                ...
                // Опционально, уменьшите размер водяного знака, если он слишком большой
        ...
        private void StopButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (waveIn != null)
            {
                // Остановить запись и очистить ресурсы видеозаписи
        ...
        private void ImageButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == true)
            {
                ...
                // Загрузите выбранное изображение и отобразите его в WImage
        ...
        {
            // Создайте экземпляр окна настроек
            Settings settingsWindow = new Settings();

            // Откройте окно настроек как диалоговое окно
        ...
        private void DisplayBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (isRecording)
            {
                // Остановите текущий захват экрана
                screenCapture.SignalToStop();
                screenCapture.WaitForStop();

                // Определите новый экран для записи на основе выбранного имени
                ...
                if (newScreen != null)
                {
                    // Запустите новый захват рабочего стола на новом дисплее
